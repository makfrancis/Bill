...
public class BarsException extends Exception{
	...
	public static final String INVALID_END_DATE_FORMAT = "ERROR: Invalid End Date Format";
	public static final String BILLING_CYCLE_NOT_ON_RANGE = "ERROR: Billing Cycle not on range";
